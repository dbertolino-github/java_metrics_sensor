...
/**
 * FunctionListenerPack is a useful class that contains all the data
 * collected by the FunctionListener of parse tree walker.
 * LICENSE: Apache-2.0
 * @author Dario Bertolino
 * @since 26/02/2017
 */
public class FunctionListenerPack {
    ...
    public FunctionListenerPack(String name){
        this.CC = 1;
        this.LOC = 0;
        this.numParam = 0;
    ...
    public String getFunctionPrototipe(){
        String param = "(";
        if(numParam == 0){
            param = param + ")";
        }else{
    ...
    public String toCsvString(String separator){
        return className + separator + getFunctionPrototipe() + separator + LOC + separator + CC;
    }
